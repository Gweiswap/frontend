...
export function useDecimals(contract: Contract | null | undefined) {
  ...
  useEffect(() => {
    ...
    contract
      .decimals()
      .then((response) => setDecimals(response))
      .catch(() => setDecimals(''))
  }, [contract])
...
export function useSymbol(contract: Contract | null | undefined) {
  ...
  useEffect(() => {
    ...
    contract
      .symbol()
      .then((response) => setSymbol(response))
      .catch(() => setSymbol(''))
  }, [contract])
