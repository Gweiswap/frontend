...
export const getTreasuryConTract = (signer?: Signer | Provider, chainId?: number) => {
  return getContract({
    abi: treasuryAbi,
    address: getContractTreasuryXOX(chainId),
    chainId,
    signer,
  }) as TreasuryXOX
}

export const getContractXOXToken = (signer?: Signer | Provider, chainId?: number) => {
  return getContract({
    abi: xoxTokenAbi,
...
export const getContractFarmingLP = (signer?: Signer | Provider, chainId?: number) => {
  return getContract({
    abi: XOXFarmingLPAbi,
    address: getContractFarmingLPAddress(chainId),
    chainId,
    signer,
  }) as XOXFarmingLP
}
...
export const getContractXOXPool = (signer?: Signer | Provider, chainId?: number) => {
  console.log(" getXOXPoolAddress(chainId): ",  getXOXPoolAddress(chainId),);
...
export const getContractXOXSecondPool = (signer?: Signer | Provider, chainId?: number) => {
  return getContract({
    abi: xoxPoolAbi,
    address: getXOXSecondPoolAddress(chainId),
    chainId,
    signer,
  }) as Erc20XOXPool
}

export const getContractPreSale = (signer?: Signer | Provider, chainId?: number) => {
  return getContract({
    abi: xOXPreSaleAbi,
    address: getContractPreSaleAddress(chainId),
    chainId,
    signer,
  }) as XOXPreSale
}
