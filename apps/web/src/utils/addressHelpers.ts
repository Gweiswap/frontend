...
export const getXOXTokenAddressBridge = (chainId?: number) => {
  return getAddress(addresses.xoxToken, chainId)
}
...
export const getXOXSecondPoolAddress = (chainId?: number) => {
  return getAddress(addresses.contractXOXSecondPool, chainId)
}
